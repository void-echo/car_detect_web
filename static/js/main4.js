...
* --------------------------------------------------------------------
*
* Template : sasco - Business Consulting WordPress Theme
* Author : rs-theme
...
(function($) {
  ...
  //preloader
    $(window).on( 'load', function() {
        ...
        $("#pre-load").delay(500).fadeOut(300);
        $(".pre-loader").delay(500).fadeOut(300);
    ...
    if ($('#rs-accordion-inner').length) {
        $(function(){
          $('#rs-accordion-inner .accordion-item:first-child .accordion-button').removeClass('collapsed');
          $('#rs-accordion-inner .accordion-item:first-child .accordion-collapse').addClass('show');
        })
    }
